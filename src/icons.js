...
export const Bible = ({ color }) => (
  <View pointerEvents="none">
    ...
    >
      <Path
        fill={color}
        d="M21 18.984v-12.984h-9v12.984h9zM21 3.984q0.797 0 1.406 0.609t0.609 1.406v12.984q0 0.797-0.609 1.406t-1.406 0.609h-18q-0.797 0-1.406-0.609t-0.609-1.406v-12.984q0-0.797 0.609-1.406t1.406-0.609h18zM12.984 14.484h7.031v1.5h-7.031v-1.5zM12.984 9.516h7.031v1.5h-7.031v-1.5zM12.984 12h7.031v1.5h-7.031v-1.5z"
      />
    </Svg>
  </View>
);
...
export const Calendar = ({ color }) => (
  <View pointerEvents="none">
    ...
    >
      <Path
        fill={color}
        d="M18.984 18.984v-10.969h-13.969v10.969h13.969zM18.984 3q0.797 0 1.406 0.609t0.609 1.406v13.969q0 0.797-0.609 1.406t-1.406 0.609h-13.969q-0.844 0-1.43-0.586t-0.586-1.43v-13.969q0-0.797 0.586-1.406t1.43-0.609h0.984v-2.016h2.016v2.016h7.969v-2.016h2.016v2.016h0.984zM16.547 11.063l-5.953 5.953-3.188-3.188 1.078-1.078 2.109 2.109 4.875-4.875z"
      />
    </Svg>
  </View>
);

export const Graduation = ({ color }) => (
  <View pointerEvents="none">
    <Svg
      width={22}
      height={22}
